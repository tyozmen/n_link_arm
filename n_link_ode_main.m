...
[t,X]= ode45(@(t,Q)n_link_dynamics(Q,M,C,Tg,B,g),[0 15],[pi/3 pi/2 pi-.3 0 0 0],opts);
...
opts = odeset('RelTol',1e-4,'AbsTol',1e-8,'Refine',30);
[t_FL,X_FL]= ode45(@(t_FL,Q)n_link_dynamics_FeedbackLinearization(Q,M,C,Tg,B,g),[0 3],[pi/3 pi/2 pi-.3 0 0 0],opts);
